...
public class CarWashesDatabase {
     ...
     * user's all orders
     */
    public static final String KEY_USER_ORDER_ID = "order_id";
     ...
     * public constructor
     */
    public CarWashesDatabase(Context c) {
        context = c;
    }
     ...
     */
    public long addToUserOrders(int id, String name, String address, String services, String date, String price, String status) {
        ContentValues cv = new ContentValues();
        cv.put(KEY_USER_ORDER_ID, id);
        cv.put(KEY_CAR_WASH_NAME, name);
        cv.put(KEY_CAR_WASH_ADDRESS, address);
    ...
    public Cursor getUserOrders() {
        String[] columns = new String[]{ROW_ID, KEY_USER_ORDER_ID, KEY_CAR_WASH_NAME, KEY_CAR_WASH_ADDRESS, KEY_USER_ORDER_SERVICES, KEY_USER_ORDER_DATE, KEY_USER_ORDER_PRICE, KEY_USER_ORDER_STATUS};
