...
import developer.marat.apps.days.DB.UntilAdapter;
...
public class UntilTabView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mList = (RecyclerView) v3.findViewById(R.id.recycler_view);
        mEmptyText = (TextView) v3.findViewById(R.id.empty_text);
