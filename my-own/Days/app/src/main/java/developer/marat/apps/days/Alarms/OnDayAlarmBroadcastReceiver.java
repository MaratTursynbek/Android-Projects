...
public class OnDayAlarmBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        notificationBuilder.setContentTitle("Today is");
        ...
        data.updateEntry(rowId, row.get(0), row.get(1), row.get(2), row.get(3), row.get(4), Integer.parseInt(row.get(5)), Integer.parseInt(row.get(6)), isDayBefore, false);
        data.close();
    }
}
